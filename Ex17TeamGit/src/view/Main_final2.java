				...
				if (id == null) {// 일치하는 아이디가 없으면
					...
					if (member.name == null) {// 동물정보가 없으면
						...
						for (CatVO cat : typeList) {
							slowPrint(20,cat.getInfo());
							slowPrint(20,cat.getInfo2());
							System.out.println();
							System.out.println();
						}
	...
	public static void game(MemberVO member) {
		while (true) {
			...
			if (menu3 == 1) {// 밥주기
				...
				slowPrint(50,"어떤걸로 주시겠습니까?");
				System.out.println();
				slowPrint(50,"[1]사료 [2]츄르 [3]캔참치 [4]닭고기 >> ");
				System.out.println();
				int food = sc.nextInt();
				if (food == 1) {
					slowPrint(50,"사료주기");
				...
				slowPrint(50,"먹이주기, 놀아주기, 낮잠자기만 가능합니다.");
			} // 잘못 입력
		} // while
