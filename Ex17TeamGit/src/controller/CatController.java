...
public class CatController {
	...
	//고양이 정보 등록
	public void enrollCatConn(MemberVO member, int cat, String name) {
		String type = null;
		if(cat == 1) {
			type = "페르시안";
		}else if(cat == 2) {
...
//	경험치 업데이트
	public void updateExpConn(MemberVO member, int exp) {
...
//	피로도 업데이트
	public void updateTiredConn(MemberVO member, int tired) {
...
//	날짜 업데이트
	public void updateDateConn(MemberVO member) {
